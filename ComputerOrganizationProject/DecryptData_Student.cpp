...
void decryptData_01(char* data, int sized)
{
	...
	CONTINUE1:
        ...
        // The two pointers are used for scaling through the array of values. One to increment the place in the string
        // and the other to check it.
	...
	DECRYPT:
            ...
            // je being jump if equal or a conditional jump in this case checking if the end of the array has been
            // reached.
		cmp edx, ecx;
		je EXIT_DECRYPT;
