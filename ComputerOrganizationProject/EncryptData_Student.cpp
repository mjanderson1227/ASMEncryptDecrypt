...
void encryptData_01(char* data, int datalength)
{
	...
	ROUNDLOOP:
            ...
            // leading the hash function into the base pointer to help narrow down data for encryption as the loops take
            // place through the data array gNumRounds being used to keep track of incrementation
	...
	CONTINUE1:
        ...
        // Like with the decryption, the encyption will also need to know when to stop, where the pointer is when
        // scalling through the data array and where the pointer is to check on the encrpytion itself
